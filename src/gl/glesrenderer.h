...
/** \brief A render program that can be used as a simple replacement for the OpenGL fixed
  ...
  *
  * GLESRenderer contains functions for projecting m_points from modelspace to screen and unprojecting m_points
...
public:
    ...
    /**
      * Returns the m_points on near and far clipping plane, that correspond to the
    ...
    /**
      * Set size of m_points drawn with GL_POINTS.
      * Defaults to 2.0.
      */
